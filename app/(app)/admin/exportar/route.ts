...
export async function GET(req: NextRequest) {
  ...
  hoja(
    ...
    [
      ...
      { header: "cemento", key: "cemento", width: 12 },
  ...
  if (que === "todo") {
    ...
    hoja(
      ...
      [
        ...
        { header: "placa", key: "placa", width: 26 },
        { header: "cemento", key: "cemento", width: 10 },
      ...
      tds.map((t) => {
        ...
        return {
          codigo: t.codigo,
          tarjeta: t.tarjetaPalabra ? `${t.tarjetaLetra} ${t.tarjetaPalabra.toUpperCase()}` : "",
          placa: t.estanteriaEtiqueta ?? "",
          cemento: t.cemento,
    ...
    hoja(
      ...
      movs.map((m) => ({
        cuando: m.creadoEn,
        tanda: m.tandaCodigo,
        tarjeta: m.tandaPalabra ? m.tandaPalabra.toUpperCase() : "",
